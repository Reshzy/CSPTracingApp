...
- M6 visual/parity tracking and confidence safety: NOT RUN for tracking (Prompt 16a clip/stride/pending tests PASS; Prompt 16b applied-mapped live CSP copyUs/mapWaitUs/pending<=2 PASS including resize fallback; OpenCV estimator is prompt 17)
...
- [ ] Visual tracking tested with textured drawing and new strokes. (16a/16b: ROI clip/pack/pending and live mapped readback PASS; OpenCV estimator is prompt 17)
